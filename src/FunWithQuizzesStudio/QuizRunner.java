...
public class QuizRunner {
    ...
    public static void main(String[] args) {
        ...
        Checkbox newQuestion1 = new Checkbox(2, "Who is the best cat?", possAns1, correctAns1);
        myQuiz.addQuestion(newQuestion1);
        ArrayList<String> possAns2 = new ArrayList<>(Arrays.asList("Doc", "Tillie", "Gizmo", "Benji", "Nala"));
        MultipleChoice newQuestion2 = new MultipleChoice(1, "Who won the costume contest?", 3, possAns2);
